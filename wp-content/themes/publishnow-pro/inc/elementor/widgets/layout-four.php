...
class PublishnowPro_Layout_Four_Widget extends Widget_Base {

	public function get_name() {
		return 'publishnow-layout-four';
	}

	public function get_title() {
		return esc_html__( 'Layout Four', 'publishnow' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .layout-title' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .layout-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-four .layout-title',
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .view-more' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .view-more:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-four .view-more',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .entry-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .entry-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-four .entry-title',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .cat-links a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-four .cat-links a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'          => 'cat_typography',
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-four .cat-links a',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
	...
	protected function render() {
		...
		if ( $four->have_posts() ) :
			...
			// Wrapper classes
			$wrap_classes = array( 'publishnow-elements', 'layout-four' );
			...
			<div class="<?php echo esc_attr( $wrap_classes ); ?>">
				...
				<div class="posts">
					<?php while ( $four->have_posts() ) : $four->the_post(); ?>
						<div <?php post_class( 'post-layout-grid-four' ); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new PublishnowPro_Layout_Four_Widget() );
