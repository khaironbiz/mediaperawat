...
class PublishnowPro_Layout_Three_Widget extends Widget_Base {

	public function get_name() {
		return 'publishnow-layout-three';
	}

	public function get_title() {
		return esc_html__( 'Layout Three', 'publishnow' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .layout-title' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .layout-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-three .layout-title',
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .view-more' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .view-more:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-three .view-more',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .entry-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .entry-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-three .entry-title',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .entry-summary' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-three .entry-summary',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .post-meta' => 'color: {{VALUE}};',
					'{{WRAPPER}} .publishnow-elements.layout-three .post-meta a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-three .post-meta a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-three .post-meta',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
	...
	protected function render() {
		...
		if ( $three->have_posts() ) :
			...
			// Wrapper classes
			$wrap_classes = array( 'publishnow-elements', 'layout-three' );
			...
			<div class="<?php echo esc_attr( $wrap_classes ); ?>">
				...
				<?php while ( $three->have_posts() ) : $three->the_post(); ?>

					<div <?php post_class(); ?>>

						<div class="layout-three-header">
...
Plugin::instance()->widgets_manager->register_widget_type( new PublishnowPro_Layout_Three_Widget() );
