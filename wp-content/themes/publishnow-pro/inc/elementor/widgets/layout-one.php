...
class PublishnowPro_Layout_One_Widget extends Widget_Base {

	public function get_name() {
		return 'publishnow-layout-one';
	}

	public function get_title() {
		return esc_html__( 'Layout One', 'publishnow' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .layout-title' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .layout-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-one .layout-title',
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .view-more' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .view-more:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-one .view-more',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .entry-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .entry-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-one .large-post .entry-title',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-one .small-posts .entry-title',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .cat-links a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .cat-links a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'          => 'cat_typography',
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-one .cat-links a',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .entry-summary' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-one .entry-summary',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .post-meta' => 'color: {{VALUE}};',
					'{{WRAPPER}} .publishnow-elements.layout-one .post-meta a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-one .post-meta a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-one .post-meta',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
	...
	protected function render() {
		...
		if ( $one->have_posts() ) :
			...
			// Wrapper classes
			$wrap_classes = array( 'publishnow-elements', 'layout-one' );
...
Plugin::instance()->widgets_manager->register_widget_type( new PublishnowPro_Layout_One_Widget() );
