...
class PublishnowPro_Layout_Eight_Widget extends Widget_Base {

	public function get_name() {
		return 'publishnow-layout-eight';
	}

	public function get_title() {
		return esc_html__( 'Layout Eight', 'publishnow' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .layout-title' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .layout-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-eight .layout-title',
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .view-more' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .view-more:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-eight .view-more',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .entry-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .entry-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-eight .large-post .entry-title',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-eight .small-posts .entry-title',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .cat-links a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .cat-links a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'          => 'cat_typography',
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-eight .cat-links a',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->start_controls_section(
			'section_excerpt_color',
			[
				'label'         => esc_html__( 'Excerpt', 'publishnow' ),
				'tab'           => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .entry-summary' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-eight .entry-summary',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->start_controls_section(
			'section_meta_color',
			[
				'label'         => esc_html__( 'Post Meta', 'publishnow' ),
				'tab'           => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .post-meta' => 'color: {{VALUE}};',
					'{{WRAPPER}} .publishnow-elements.layout-eight .post-meta a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-eight .post-meta a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-eight .post-meta',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
	...
	protected function render() {
		...
		if ( $eight->have_posts() ) :
			...
			// Wrapper classes
			$wrap_classes = array( 'publishnow-elements', 'layout-eight' );
			...
			<div class="<?php echo esc_attr( $wrap_classes ); ?>">
				...
				<div class="posts">
					<?php while ( $eight->have_posts() ) : $eight->the_post(); ?>

						<?php if ( $eight->current_post == 0 ) : ?>
							<div <?php post_class( 'large-post' ); ?>>
								<div class="thumbnail">
									<?php publishnow_post_thumbnail( 'publishnow-post-small' ); ?>
								</div>
...
Plugin::instance()->widgets_manager->register_widget_type( new PublishnowPro_Layout_Eight_Widget() );
