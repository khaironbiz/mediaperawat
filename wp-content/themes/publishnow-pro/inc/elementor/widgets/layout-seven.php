...
class PublishnowPro_Layout_Seven_Widget extends Widget_Base {

	public function get_name() {
		return 'publishnow-layout-seven';
	}

	public function get_title() {
		return esc_html__( 'Layout Seven', 'publishnow' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .layout-title' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .layout-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-seven .layout-title',
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .view-more' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .view-more:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-seven .view-more',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .entry-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .entry-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-seven .entry-title',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .cat-links a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .cat-links a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'          => 'cat_typography',
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-seven .cat-links a',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .entry-summary' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-seven .entry-summary',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .post-meta' => 'color: {{VALUE}};',
					'{{WRAPPER}} .publishnow-elements.layout-seven .post-meta a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
					'{{WRAPPER}} .publishnow-elements.layout-seven .post-meta a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'      => '{{WRAPPER}} .publishnow-elements.layout-seven .post-meta',
				'scheme'        => Scheme_Typography::TYPOGRAPHY_1,
			]
		);
	...
	protected function render() {
		...
		if ( $seven->have_posts() ) :
			...
			// Wrapper classes
			$wrap_classes = array( 'publishnow-elements', 'layout-seven' );
			...
			<div class="<?php echo esc_attr( $wrap_classes ); ?>">
				...
				<div class="posts">
					<?php while ( $seven->have_posts() ) : $seven->the_post(); ?>

						<div <?php post_class( 'post-layout-default' ); ?>>
							<div class="thumbnail">
...
Plugin::instance()->widgets_manager->register_widget_type( new PublishnowPro_Layout_Seven_Widget() );
