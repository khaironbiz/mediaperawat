 ...
 */
function publishnow_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function publishnow_sanitize_css( $css ) {
 ...
 */
function publishnow_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function publishnow_sanitize_email( $email, $setting ) {
 ...
 */
function publishnow_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function publishnow_sanitize_html( $html ) {
 ...
 */
function publishnow_sanitize_image( $image, $setting ) {
 ...
 */
function publishnow_sanitize_nohtml( $nohtml ) {
 ...
 */
function publishnow_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function publishnow_sanitize_number_range( $number, $setting ) {
 ...
 */
function publishnow_sanitize_select( $input, $setting ) {
 ...
 */
function publishnow_sanitize_url( $url ) {
