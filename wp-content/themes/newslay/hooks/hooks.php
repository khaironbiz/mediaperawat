  ...
  function newslay_frontpage_trending_post_section()
    {
        ...
        { 
         $number_of_posts = '4';
         $newsup_weekly_news_category = newsup_get_option('select_weekly_news_category');
         $newsup_all_posts_main = newsup_get_posts($number_of_posts, $newsup_weekly_news_category);
        ?>
